        ...
        if(this.props.note){
            return(
                <div className="editor">
                    <input className="editor__title" value={this.state.title}  placeholder='Untitled note'
                    ...
                    <div>
                        <button className="button button--secondary" onClick={this.handleNoteRemoval.bind(this)}> Delete Note </button>
                    </div>
